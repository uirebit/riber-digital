            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <div className="space-y-4 text-lg text-muted-foreground leading-relaxed">
                  ...
                  <p>
                    Detrás de <span className="font-semibold text-foreground">Riber<span className="text-accent">digital</span></span> hay un consultor tecnológico con más de 15 años de experiencia, liderando equipos y desarrollando herramientas y plataformas para aerolíneas y entornos empresariales de alta exigencia. A lo largo de este recorrido he participado tanto en la definición de soluciones con el cliente como en la implementación de aplicaciones críticas, sistemas backend y procesos de automatización donde la precisión y la escalabilidad son clave.
                  </p>
                  <p>
