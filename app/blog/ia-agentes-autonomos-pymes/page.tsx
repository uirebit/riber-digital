...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://ribersistemas.es/blog/ia-agentes-autonomos-pymes",
  },
  openGraph: {
    ...
    url: "https://ribersistemas.es/blog/ia-agentes-autonomos-pymes",
    type: "article",
...
const jsonLd = {
  ...
  url: "https://ribersistemas.es/blog/ia-agentes-autonomos-pymes",
  author: { "@type": "Person", name: "Tiberiu David", url: "https://ribersistemas.es/nosotros", sameAs: "https://www.linkedin.com/in/andrei-tiberiu-david/" },
  publisher: { "@type": "Organization", name: "ribersistemas", url: "https://ribersistemas.es" },
  mainEntityOfPage: { "@type": "WebPage", "@id": "https://ribersistemas.es/blog/ia-agentes-autonomos-pymes" },
  articleSection: "Inteligencia Artificial",
  inLanguage: "es-ES",
  breadcrumb: {
    "@type": "BreadcrumbList",
    itemListElement: [
      { "@type": "ListItem", position: 1, name: "Inicio", item: "https://ribersistemas.es" },
      { "@type": "ListItem", position: 2, name: "Blog", item: "https://ribersistemas.es/blog" },
      { "@type": "ListItem", position: 3, name: "La IA ya no espera órdenes", item: "https://ribersistemas.es/blog/ia-agentes-autonomos-pymes" },
    ],
  },
}
